...
namespace RentalKendaraan_20180140052.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        {
            var rentKendaraanContext = _context.Peminjaman.Include(p => p.IdCostumerNavigation).Include(p => p.IdJaminanNavigation).Include(p => p.IdKendaraanNavigation).Include(p => p.IdPeminjamanNavigation);
